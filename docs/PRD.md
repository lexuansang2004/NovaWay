...
- Unity AR Terrain Mesh prototype (tách biệt hoàn toàn khỏi mobile app chính cho tới khi đạt test gate riêng: FPS, nhiệt độ, pin, độ ổn định, fallback ánh sáng yếu). **Baseline cụ thể (08/2026):** đây là một prototype nghiên cứu độc lập cho báo cáo hội đồng, không phải tính năng NovaWay MVP — phạm vi/thiết bị/timeline đầy đủ ở `docs/research/AR_TERRAIN_THESIS_BASELINE.md`. **Hướng sản phẩm làm rõ 09/2026:** Survey Mode thu thập địa hình bằng LiDAR; Drive Mode trên thiết bị phổ thông dùng bản đồ quét sẵn để cảnh báo sớm, TPP mặc định/FPP bổ sung; xem addendum Survey/Drive. Chưa thêm hướng này vào MVP.
