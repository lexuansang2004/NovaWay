...
| R3-6 | ✅ Quyết định production hosting (khác staging hiện tại) | P2 | Vẫn mở từ R1 (`OPEN_ITEMS_AFTER_MVP.md` §6) — Fly.io được ghi nhận là ứng viên đánh giá lại qua TDR riêng khi cần scale | **Hoàn tất 07/2026** — chốt dùng luôn Railway+Vercel (staging hiện tại) làm production, không dựng hạ tầng mới, đúng tinh thần "chưa cần triển khai thật nếu chưa có áp lực traffic". Fly.io giữ vị trí ứng viên khi cần scale thật. TDR: `docs/architecture/TDR-production-hosting.md`. |
...
**Kết quả cuối Sprint R3 (07/2026):** R3-1/R3-2/R3-3/R3-5/R3-6 hoàn tất. R3-4 (UI capture khuôn mặt thật) hoãn sang R4 — spike xác nhận không thể verify thật trong môi trường hiện tại (không có Android/iOS thật, không có đường vòng qua trình duyệt như các mục khác). DoD tối thiểu (R3-1/R3-3) đã đạt từ sớm; toàn bộ backlog P1 trở lên đã đóng.
